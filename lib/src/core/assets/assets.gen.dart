...
class $AssetsRiveGen {
  ...
  /// File path: assets/rive/realistic.riv
  String get realistic => 'assets/rive/realistic.riv';

  /// File path: assets/rive/realistic_bouncing_dvd_logo.riv
  String get realisticBouncingDvdLogo =>
      'assets/rive/realistic_bouncing_dvd_logo.riv';

  /// List of all assets
  List<String> get values => [realistic, realisticBouncingDvdLogo];
}
